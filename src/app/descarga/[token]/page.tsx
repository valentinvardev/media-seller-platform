  ...
  if (!info) {
    return (
      ...
      >
        ...
        <div>
          <h1 className="font-display font-800 uppercase text-2xl text-white mb-2">Link no válido</h1>
          <p className="text-sm max-w-xs" style={{ color: "#64748b" }}>
            Este link de descarga no es válido, ya expiró, o la compra no fue aprobada todavía.
          </p>
        </div>
        <Link href="/" className="mt-2 px-5 py-2.5 rounded-xl text-sm font-medium transition-all" style={{ background: "#1a1a2e", color: "#94a3b8" }}>
          Volver al inicio
        </Link>
      </div>
    );
