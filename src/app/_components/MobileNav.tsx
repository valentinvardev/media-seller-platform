    ...
    <div className="md:hidden">
      ...
      >
        ...
        <div className="px-4 pb-8 shrink-0">
          <a href="#eventos" onClick={() => setOpen(false)}
            className="flex items-center justify-center gap-2 w-full py-3 rounded-xl font-display font-800 uppercase tracking-wider text-white text-sm transition-all hover:opacity-90"
